...
/**
 * @brief Вычитает две матрицы в третью
 * @param A, B, result (matrix_t *) указатель на матрицы откуда, что вычитать и
 * результат
 *
 * @return (int)
 *
 ...
 *
 * 2 - CALCULATION_ERROR если матрицы не одного размера (не сделать вычитание)
 */
